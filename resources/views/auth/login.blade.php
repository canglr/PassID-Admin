...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="/tema/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>PASS</b> ID</a>
  </div>
  <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="/tema/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
